...
const data = [
    {id: 1, pb: "climate change", threshhold: -2.35, shoot: 18.95, scale: prosentConverter(-2.35, 18.95)},
    {id: 1, pb: "Ocean acidification", threshhold: -1.59, shoot: 15.33, scale: prosentConverter(-1.59, 15.33)},
    {id: 1, pb: "Nitrogen", threshhold: 100, shoot: 72.7, scale: prosentConverter2(100, 72.7)},
    {id: 1, pb: "Phosphorus", threshhold: 1.1, shoot: 4, scale: prosentConverter(1.1, 4)},
    {id: 1, pb: "Biodiversity", threshhold: 0.6, shoot: 0.45, scale: prosentConverter2(0.6, 0.45)},
